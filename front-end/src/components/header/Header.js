...
const Header = () => {
  ...
  return (
    <div
      className={` ${
        isScrolled && "bg-stone-200"
      } h-20 fixed flex justify-around w-screen md:flex fixed `}
    >
      <div className="shrink-0 w-30 md:flex">
        <img
          src={image1}
          className="flex-shrink-0 truncate block m-auto flex-row overflow-hidden flex-col w-28"
        />
      </div>
